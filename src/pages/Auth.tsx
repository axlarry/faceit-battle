...
const Auth = () => {
  ...
  useEffect(() => {
    ...
    if (meta)
      meta.setAttribute(
        "content",
        "Login sau creează cont pentru a gestiona lista de prieteni FACEIT.",
      );
  }, []);
  ...
  const signUp = async () => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: "Am trimis un link de confirmare.",
      });
    }
  };
      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription className="text-center">
            Gestionează-ți în siguranță lista de prieteni
          </CardDescription>
        </CardHeader>
        <CardContent>
