...
export const PlayerInfo = memo(({ nickname, level, elo, lcryptData, isLive }: PlayerInfoProps) => {
  return (
    <div className="flex-1 min-w-0">
      <div className="flex flex-col gap-1">
        {/* Nickname with live indicator */}
        <div className="flex items-center gap-2 justify-between">
          <h3 className="text-base font-bold text-foreground truncate">{nickname}</h3>
          {isLive && (
