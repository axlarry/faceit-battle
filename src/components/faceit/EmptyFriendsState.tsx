...
export const EmptyFriendsState = React.memo(
  ({ onMigrate }: EmptyFriendsStateProps) => {
    return (
      <div className="text-center py-8 md:py-10">
        ...
        <p className="text-[#9f9f9f] text-sm md:text-base mb-1">
          Folosește căutarea de mai sus pentru a adăuga jucători.
        </p>
        <p className="text-[#9f9f9f] text-xs md:text-sm mb-4">
          Adăugarea/ștergerea se confirmă cu parolă.
        </p>
        {onMigrate && (
