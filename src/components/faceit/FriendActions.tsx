  ...
  return (
    <div className="flex gap-2 mt-2 sm:mt-0" onClick={onLinkClick}>
      <a
        ...
        className="bg-transparent border-2 border-[#ff6500] text-[#ff6500] hover:bg-[#ff6500] hover:text-white rounded-lg w-14 h-14 font-bold text-xs flex items-center justify-center transition-all duration-200 hover:scale-105"
      >
        <img 
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="bg-transparent border-2 border-blue-400 text-blue-400 hover:bg-blue-500 hover:border-blue-500 hover:text-white rounded-lg w-14 h-14 font-bold text-xs flex items-center justify-center transition-all duration-200 hover:scale-105"
      >
        <img 
