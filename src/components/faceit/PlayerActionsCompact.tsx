  ...
  return (
    <div className="flex gap-1" onClick={onLinkClick}>
      <a
        ...
        className={`bg-transparent border text-xs transition-all duration-200 rounded-lg w-9 h-9 flex items-center justify-center ${
          isLive 
            ? 'border-orange-400 text-orange-400 hover:bg-orange-400 hover:text-white shadow-orange-400/20 shadow-md' 
