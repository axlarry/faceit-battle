...
const ActionLink = memo(
  ({
    ...
    const baseClasses =
      "bg-transparent border-0 text-xs transition-all duration-200 rounded-lg w-9 h-9 flex items-center justify-center";
...
export const PlayerActionsCompact = memo(
  ({ nickname, steamId64, isLive, onLinkClick }: PlayerActionsCompactProps) => {
