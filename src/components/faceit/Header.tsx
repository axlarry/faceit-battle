          ...
          <div className="flex items-center justify-center gap-6">
            ...
            <div className="relative group">
              ...
              <div className="relative w-20 h-20 bg-gradient-to-br from-[#ff6500] to-[#ff8533] rounded-2xl flex items-center justify-center shadow-2xl transform group-hover:scale-110 transition-all duration-300">
                ...
                {!faviconError ? <img alt="Site Icon" onError={handleFaviconError} onLoad={() => console.log('✅ Favicon loaded successfully')} width="48" height="48" src="/lovable-uploads/9071fcff-bc31-40f0-9a88-68f00e8b0347.png" className="relative z-10 w-12 h-12 drop-shadow-lg transform group-hover:rotate-12 transition-transform duration-300 rounded border-[#ff6500]" /> : <div className="relative z-10 text-white text-2xl font-bold">F</div>}
                {/* Orbital Ring */}
