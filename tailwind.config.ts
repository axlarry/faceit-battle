    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          ...
          "50%": {
            boxShadow:
              "0 0 40px rgba(139, 92, 246, 0.8), 0 0 80px rgba(139, 92, 246, 0.4), 0 0 120px rgba(139, 92, 246, 0.2)",
        ...
        orbital: {
          ...
          "25%": {
            opacity: "0.7",
            transform:
              "rotate(90deg) translateX(30px) rotate(-90deg) scale(1.2)",
          },
          "50%": {
            opacity: "1",
            transform:
              "rotate(180deg) translateX(25px) rotate(-180deg) scale(0.8)",
          },
          "75%": {
            opacity: "0.7",
            transform:
              "rotate(270deg) translateX(30px) rotate(-270deg) scale(1.1)",
          },
          "100%": {
            transform:
              "rotate(360deg) translateX(25px) rotate(-360deg) scale(1)",
            opacity: "0.3",
          },
        },
        "rotate-slow": {
